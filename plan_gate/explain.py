...
SYSTEM = (
    ...
    "For each finding write one sentence: what changes, and what stops working or is at risk if it is applied. "
    "Do not claim certainty you cannot have: a replacement risks the data it held, snapshots and deletion protection may exist, "
    "and a bucket ACL grants permissions at the bucket level rather than guaranteeing every object is readable. "
